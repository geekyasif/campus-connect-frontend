...
alt="profile"
      ...
      <p className="text-lg font-bold">{user?.user?.personal_details?.fullName}</p>
      <p className="text-xs lg:text-sm text-gray-500 font-semibold">@{user?.user?.personal_details?.username}</p>
    </div>
  );
}
